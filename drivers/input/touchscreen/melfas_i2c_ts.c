...
struct gs_data *TS_updateFW_gs_data = NULL;
...
static int mcsdl_i2c_update_firmware(void); 
...
static int mcsdl_i2c_update_firmware(void)
{
	...
	mm_segment_t oldfs;
    uint16_t	length;
	int ret = 0;           //"/data/melfas_ts_update_firmware_c8500.bin";
	const char filename[]="/sdcard/update/melfas_ts_update_firmware_c8500.bin";
