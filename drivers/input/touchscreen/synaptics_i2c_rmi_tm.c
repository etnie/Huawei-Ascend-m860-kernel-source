...
static extra_key_region   touch_extra_key_region =
{
    ...
    {
       {(TS_X_MAX*1/8),   (TS_Y_MAX-TS_KEY_Y_MAX/2+24), 180, TS_KEY_Y_MAX/2, KEY_BACK},  /* back key */
       {(TS_X_MAX*3/8),   (TS_Y_MAX-TS_KEY_Y_MAX/2+24), 180, TS_KEY_Y_MAX/2, KEY_MENU},  /* menu key */
       {(TS_X_MAX*5/8),   (TS_Y_MAX-TS_KEY_Y_MAX/2+24), 180, TS_KEY_Y_MAX/2, KEY_HOME},  /* home key */
       {(TS_X_MAX*7/8),   (TS_Y_MAX-TS_KEY_Y_MAX/2+24), 180, TS_KEY_Y_MAX/2, KEY_SEARCH},  /* Search key */
    },
};
...
static void synaptics_ts_work_func(struct work_struct *work)
{
	...
	for (i = 0; i < ((ts->use_irq && !bad_data) ? 1 : 5); i++) { 	
		...
		if (ret < 0) {
			...
			if(machine_is_msm7x25_c8500() || machine_is_msm7x25_c8150() || machine_is_msm7x25_u8150())
			{
			  x2 = x2;
			  y2 = ts->max_y - y2;
...
succeed_find_device:
	...
	/*decrease leak current, becasue synaptics reset pin is connected to GND.*/
