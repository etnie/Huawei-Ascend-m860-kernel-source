...
{0x0F12, 0x000A},	// #TVAR_afit_pBaseVals[166]    	// saturation
...
{0x0F12, 0x3203},	// #TVAR_afit_pBaseVals[242]
...
{0x0F12, 0x000A},	// #TVAR_afit_pBaseVals[248]    	// saturation
...
{0x0F12, 0x2D02},	// #TVAR_afit_pBaseVals[324]
...
{0x0F12, 0x000A},	// #TVAR_afit_pBaseVals[330]    	// saturation
...
{0x0F12, 0x2D02},	// #TVAR_afit_pBaseVals[406]
...
static int s5k4cdgx_probe_init_sensor(const struct msm_camera_sensor_info *data)
{
	...
	if (rc < 0)
	{
        CDBG("s5k4cdgx_i2c_write_w 0x002c rc=%d", rc);
		goto init_probe_fail;
	}
	rc = s5k4cdgx_i2c_write_w(0x002e, 0x0040);
	if (rc < 0)
	{
        CDBG("s5k4cdgx_i2c_write_w 0x002e rc=%d", rc);
